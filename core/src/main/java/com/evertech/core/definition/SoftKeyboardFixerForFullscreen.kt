 ...
 */
 ...
 class SoftKeyboardFixerForFullscreen private constructor(activity: Activity) {

    private val mContentView: View//我们设置的contentView
    private val mFrameLayoutParams: FrameLayout.LayoutParams//我们设置的contentView的layoutParams
    ...
    private var barStatusHeight = 0//状态栏高度

    private var lastUsableHeight = 0//上一次的可用高度
    private val lastUsableWidth = 0//上一次的可用宽度
    ...
    init {
        ...
        mContentView.viewTreeObserver.addOnGlobalLayoutListener {
            ...
            val heightRoot = content.rootView.height//包含虚拟按键的高度（如果有的话）
            val heightDecor = content.height//不含虚拟按键的高度，貌似不包含状态栏高度
    ...
    fun assistActivity(activity: Activity) {
        SoftKeyboardFixerForFullscreen(activity)
    }
